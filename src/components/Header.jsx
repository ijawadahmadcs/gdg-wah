...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 z-50 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-xl font-extrabold text-gray-900 dark:text-white truncate">
                GDG CUI-Wah
              </h1>
              <p className="text-xs text-gray-500 dark:text-gray-400 truncate">Developer Community</p>
            </div>
          </Link>
        ...
        <div
          className={`md:hidden mt-2 bg-white dark:bg-gray-950 rounded-md shadow-md overflow-hidden w-full max-w-full transform transition-all duration-300 ${
        ...
        >
          {navigation.map(item => (
            <Link
              ...
              className="block px-4 py-3 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition"
            >
              {item.name}
            </Link>
          ))}
